...
public class MaquinaDAO 
{
    ...
    public static List<Maquinas> listarOperacional() throws SQLException
    {
        String sql = """
        SELECT id, nome, setor WHERE status = "OPERACIONAL"
        """;
        ...
        PreparedStatement stmt =  conn.prepareStatement(sql))
        {
            ...
            while (rs.next())
            {
                ...
                var maquina = new Maquina(id, nome, setor, setor)
            }
        }
    }
}
