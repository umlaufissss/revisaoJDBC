...
public class ServiceMaquina 
{
    ...
    {
        int validarId = MaquinaDAO.buscarPorId(id);

        // MaquinaDAO.buscarPorId returns an int; check for non-positive values to
        // indicate "not found" (e.g., 0 or -1 depending on DAO implementation).
        if (validarId <= 0)
        {
